            ...
            <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-24 lg:gap-32 xl:gap-40 relative z-10">
                <div className="flex-1 w-full order-2 lg:order-1 text-center lg:text-left">
                    ...
                    >
                        ...
                        <motion.h2
                            ...
                            className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold mb-8 leading-[1.1] tracking-tight uppercase"
                        >
                            {t('about.title')}
                        </motion.h2>
                        ...
                        <motion.p
                            ...
                            className="text-lg md:text-xl text-slate-400 leading-relaxed mb-10 max-w-xl mx-auto lg:mx-0"
                        >
                            {t('about.desc')}
                        </motion.p>
                ...
                <div className="flex-1 w-full relative order-1 lg:order-2">
                    <motion.div
                        ...
                        className="aspect-square md:aspect-video lg:aspect-[4/5] w-full rounded-2xl overflow-hidden shadow-2xl relative z-10"
                    >
                        <img
